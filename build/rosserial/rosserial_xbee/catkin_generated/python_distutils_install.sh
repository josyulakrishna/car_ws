...
echo_and_run cd "/home/cair/swahana_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/cair/swahana_ws/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/cair/swahana_ws/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
